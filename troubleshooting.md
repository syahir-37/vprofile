...
## **2. Vagrant - Memcache server (mc01): change config from IPv6 to IPv4 0.0.0.0 broadcast.**
...
## **3. Vagrant - RabbitMQ server (rmq01): Update clone old file installation**
...
## **4. Vagrant - Tomcat server (app01): Mistake installed apps in wrong order**
...
## **7. Vagrant - Configuration Firewall: Old commands to the modern commands**
...
- but when try to renew the projects setup box, plugin, and vbguest. 
- Its take many times error and its hurt the purpose of automate to make it fast and more clean.
...
# making a script to reset ~/.vagrant.d for each installation
```
